...
//    CommandProcessor &cp = taskhandler1Cmd;
//    CommandProcessor &cp = taskhandler2Cmd;



    // System information handlers
    cp.addHandler(task1handlerCmd, "task1","Two options: 'suspend' or 'resume'");
    cp.addHandler(task2handlerCmd, "task2","Two options: 'suspend' or 'resume'");
